  ...
  couponApplyBtn.addEventListener('click', async () => {
    ...
    try {
      ...
      if (data && isActive && !isExpired && currencyMatch) {
        ...
        // Store discounted amount globally
        ...
        if (razorpayBtn) {
          ...
          razorpayBtn.innerHTML = `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M3 4l5.5 16h3L17 7.5 14.5 20h3L23 4h-3l-4 11L12.5 4h-3l-4 11L1.5 4H3z"/></svg> ${labelText} — ${displayPrice}`;
        }
