...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // ═══════ SUPABASE CLIENT ═══════
  const SUPABASE_URL = window.MANODEMY_CONFIG?.SUPA_URL || 'https://gvhnwmuyrwissgkumeif.supabase.co';
  const SUPABASE_ANON_KEY = window.MANODEMY_CONFIG?.SUPA_KEY || 'sb_publishable_x0gyXkcrCSaxSG23Zyi7qA__v1sBgOq';
