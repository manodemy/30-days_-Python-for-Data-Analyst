"""
Manodemy Viral High-CTR Cover Generator for SQL-12-R1 (The Ghost Employee Payroll Trap).
Features:
- Giant 3D 'WHO STILL GOT PAID? 👻💸' typography
- Context Badges: 'EX-EMPLOYEE vs HR AUDIT' + Angled 'RESIGNED 3 MONTHS AGO!' caution tape
- High-stakes Duel Cards:
    * Left: HR Payroll (Exit: Dec 2023 🛑) in Blue/Red Glass Card
    * Center: Electric white 'VS' with lightning aura
    * Right: Ex-Employee (₹1,50,000 Credited! 🔥) in Gold Glass Card with 👑 Crown & Upward Arrow
- macOS Dark Glass IDE snippet card with 3D Holographic Database & Shield Icon
- Angled Yellow Caution Tape 'CAN YOU CATCH THE LEAK? 🔍' banner
- Bottom interactive CTA: '🧠 TEST YOUR SQL: manodemy.com/q19'
...
<style>
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  body {
    width: 1080px;
    height: 1920px;
    background: radial-gradient(circle at 50% 30%, #0c142b 0%, #030611 70%, #010206 100%);
    color: #fff;
  ...
  .glow-bottom-purple {
    ...
    width: 800px;
    height: 500px;
    background: radial-gradient(circle, rgba(239, 68, 68, 0.18) 0%, rgba(0, 240, 255, 0.12) 50%, transparent 75%);
    filter: blur(80px);
    z-index: 1;
  }
  ...
  /* 3. CONTEXT BADGES (Cyan Pill + Angled Hazard Tape) */
  .badge-row {
    display: flex;
    align-items: center;
    gap: 14px;
  ...
  /* 4. THE FIGHTER DUEL (HR PAYROLL vs EX-EMPLOYEE) */
  .battle-stage {
    width: 100%;
    display: flex;
    align-items: center;
  ...
  .fighter-card-hr {
    ...
    box-shadow: 0 0 35px rgba(56, 189, 248, 0.25), inset 0 0 25px rgba(56, 189, 248, 0.08);
  }

  /* Fighter Card Right (Ex-Employee) */
  .fighter-card-emp {
    border: 2.5px solid #ffea2e;
    box-shadow: 0 0 40px rgba(250, 204, 21, 0.35), inset 0 0 25px rgba(250, 204, 21, 0.1);
  }

  /* Crown on Ex-Employee */
  .crown-badge {
    position: absolute;
    top: -24px;
    right: 20px;
  ...
  /* 5. SQL CODE CARD WITH 3D SHIELD & DB ICON */
  .code-card {
    width: 100%;
  ...
  /* 6. CAUTION TAPE 'CAN YOU CATCH THE LEAK?' BANNER */
  .caution-banner-wrap {
    width: 100%;
    display: flex;
    justify-content: center;
  ...
  /* Bottom 9:16 Full Screen Cue Accent */
  .bottom-cue-accent {
    position: absolute;
    bottom: 170px;
    left: 50%;
...
<body>
  ...
  <div class="top-meta-bar">
    ...
    <span>•</span>
    <span>DAY 12 INTERVIEW TRAP</span>
  </div>
  ...
  <div class="safe-box">
    ...
    <div class="hook-container">
      <div class="hook-line1">WHO STILL</div>
      <div class="hook-line2">
        <span class="text-grad">GOT PAID?</span>
    ...
    <div class="badge-row">
      ...
      <div class="tape-trap">
        RESIGNED 3 MONTHS AGO! ⚠️
      </div>
    </div>

    <!-- 4. THE FIGHTER DUEL (HR AUDIT vs EX-EMPLOYEE) -->
    <div class="battle-stage">
      
      <!-- HR Audit Card -->
      <div class="fighter-card fighter-card-hr">
        <div class="avatar-circle avatar-hr">
          <span class="avatar-icon">👩‍💼</span>
        </div>
        <div class="fighter-label label-hr">HR AUDIT</div>
        <div class="status-pill pill-hr-alert">EXIT: DEC 2023 🛑</div>
      </div>
      ...
      <!-- Ex-Employee Card with Crown & Upward Arrow -->
      <div class="fighter-card fighter-card-emp">
        ...
        <div class="avatar-circle avatar-emp">
          <span class="avatar-icon" style="font-size: 54px;">😎</span>
        </div>
        <div class="fighter-label label-emp">EX-EMPLOYEE</div>
        <div class="status-pill pill-emp-cash">₹1.5L CREDITED! 🔥</div>
      </div>

    </div>

    <!-- 5. SQL CODE SNIPPET CARD WITH 3D VAULT & SHIELD ICON -->
    <div class="code-card">
      <div class="code-content">
        ...
        <div class="code-snippet">
          <span class="kw">SELECT</span> p.emp_id, p.amount, p.pay_date<br>
          <span class="kw">FROM</span> payroll p <span class="kw">JOIN</span> employees e<br>
          &nbsp;&nbsp;<span class="kw">ON</span> p.emp_id = e.emp_id<br>
          <span class="kw">WHERE</span> p.pay_date &gt; e.exit_date;
        </div>
      </div>

      <!-- 3D Cyan Database / Shield Hologram SVG -->
      <div class="db-visual-icon">
        <svg class="db-svg" viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <path d="M60 48L88 58V78C88 94 75 106 60 112C45 106 32 94 32 78V58L60 48Z" fill="rgba(15, 23, 42, 0.9)" stroke="#facc15" stroke-width="3.5"/>
          <path d="M60 65V85M60 93V95" stroke="#facc15" stroke-width="4.5" stroke-linecap="round"/>
        </svg>
      </div>
    </div>

    <!-- 6. ANGLE CAUTION TAPE 'CAN YOU CATCH THE LEAK?' -->
    <div class="caution-banner-wrap">
      <div class="caution-banner">
        <div class="caution-text">CAN YOU CATCH THE LEAK? 🔍</div>
      </div>
    </div>
    ...
    <div class="cta-pill-button">
      ...
      <span class="cta-domain">manodemy.com/q19</span>
    </div>

  </div>

  <!-- Bottom 9:16 Full Screen Accent -->
...
async def build_sql12_cover():
    async with async_playwright() as p:
        ...
        official_cover = OUTPUT_DIR / "SQL-12-R1_Cover.jpg"
        official_cover_png = OUTPUT_DIR / "SQL-12-R1_Cover.png"
        ...
        grid_preview = OUTPUT_DIR / "SQL-12-R1_Grid_1x1_Preview.jpg"
        ...
        feed_preview = OUTPUT_DIR / "SQL-12-R1_Feed_4x5_Preview.jpg"
        await page.screenshot(
